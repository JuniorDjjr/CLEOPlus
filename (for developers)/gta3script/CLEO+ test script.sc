...
SCRIPT_START
{
    ...
    WHILE TRUE
        ...
        ENDIF
        IF TEST_CHEAT "P4"
            j = 123 // the value will fall off in the first var from our new script, so, "i" will be 123
            STREAM_CUSTOM_SCRIPT_FROM_LABEL Test47 j
            GET_LAST_CREATED_CUSTOM_SCRIPT j
            PRINT_FORMATTED_NOW "Created script %x" 1000 j
            WAIT 2000
            // now, "i" will be "133"
            GET_SCRIPT_VAR j 0 (k)
            k += 10
            SET_SCRIPT_VAR j 0 k
        ENDIF
        IF TEST_CHEAT "P5"
            TERMINATE_THIS_CUSTOM_SCRIPT
        ENDIF
...

{
    ...
    LVAR_FLOAT x y z
    CharInternalThread:
    PRINT_FORMATTED "Char create in internal script: %i" 200 char
...

{
    ...
    LVAR_FLOAT x y z
    CarInternalThread:
    PRINT_FORMATTED "Car create in internal script: %i" 200 car
